...
//			querySearch = "pig";
//			List<SearchResult> pigResults = s.searchInYoutube(querySearch, resultsNumber);
//			Map<String, Integer> mapPigWords = MapUtils.fillMapWords(pigResults.iterator());
//			TreeMap<String, Integer> sortedMapPigWords = MapUtils.sortMap(mapPigWords);
//			printMap(resultsNumber, mapPigWords, sortedMapPigWords, querySearch);
	...
	*/
	...
	private static void printMap(Integer resultsNumber, Map<String, Integer> mapWords,
		...
		System.out.println("\n=============================================================");
		System.out.println("   First " + resultsNumber + " videos for search on \"" + querySearch + "\". (Total words found: " + totalWords + ")" );
		System.out.println("=============================================================\n");
